...
worksheet.write(0, 13, label="商品图片")
...
for i in range(len(jUrl)):
    ...
    #货币
    priceCurrency = item['priceList'][0]['priceCurrency']
    #最小起订量
    minValue = item['priceList'][0]['minValue']
    # 最大起订量
    maxValue = item['priceList'][0]['maxValue']
    #单位编码
    ...
    worksheet.write(i, 4, label="")
    worksheet.write(i, 5, label=fullName)
    ...
    worksheet.write(i, 12, label=price)
    worksheet.write(i, 13, label=picList)
